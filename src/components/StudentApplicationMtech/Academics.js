...
export default function Academics(props) {
    ...
    const ugOptions=[
        ...
        {label:"B.Tech in CONSTRUCTION ENGINEERING",value:"B.Tech in CONSTRUCTION ENGINEERING"},
        {label:"B.Tech in APPLIED ELECTRONICS AND INSTRUMENTATION",value:"B.Tech in APPLIED ELECTRONICS AND INSTRUMENTATION"},
        ...
        {label:"B. E. Information Technology (BTECH_IT)",value:"B. E. Information Technology (BTECH_IT)"},
        ...
        {label:"BE in CONSTRUCTION ENGINEERING",value:"BE in CONSTRUCTION ENGINEERING"},
        {label:"BE in APPLIED ELECTRONICS AND INSTRUMENTATION",value:"BE in APPLIED ELECTRONICS AND INSTRUMENTATION"},
